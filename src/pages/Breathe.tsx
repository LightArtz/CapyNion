...
function Breathe() {
  ...
  const [activeButton, setActiveButton] = useState<'mute' | 'forest' | 'rain'>(
    'mute',
  );
      ...
      <div className="flex flex-col max-w-3xl mx-auto z-10 relative h-screen">
          ...
          <div className="grid grid-cols-4 gap-10">
            {durations.map((d) => (
              ...
              >
                ...
                <span className="block text-sm mt-[-3px]">
                  {d.label.split(' ')[1]}
                </span>
              </button>
            ))}
          ...
          <div className="absolute inset-x-0 bottom-[3.3%] flex justify-center">
            ...
            >
              <img
                src={
                  isPaused
                    ? '../assets/breathe/resume.svg'
                    : '../assets/breathe/pause.svg'
                }
        ...
        {selectedDuration === null && (
          <div className="flex flex-col items-center mt-6 z-[10]">
            <p className="text-xl font-semibold text-[#76B4CB] mb-4">
              Background Sound
            </p>
            <div className="flex justify-center items-center space-x-5">
              <button
                ...
                className={`px-3 p-2 rounded-xl ${
                  sound === 'muted' ? 'bg-[#92cbe0]' : 'bg-[#76B4CB]'
                } hover:bg-[#92cbe0]`}
              >
                <img
                  src="../assets/breathe/mute.svg"
                  alt="Mute"
                  width="20"
                  height="20"
                />
              ...
              <button
                ...
                className={`px-3 p-2 rounded-xl ${
                  sound === 'forest' ? 'bg-[#92cbe0]' : 'bg-[#76B4CB]'
                } hover:bg-[#92cbe0]`}
              >
                <img
                  src="../assets/breathe/tree.svg"
                  alt="Nature Sounds"
                  width="20"
                  height="20"
                />
              ...
              <button
                ...
                className={`px-3 p-2 rounded-xl ${
                  sound === 'rain' ? 'bg-[#92cbe0]' : 'bg-[#76B4CB]'
                } hover:bg-[#92cbe0]`}
              >
                <img
                  src="../assets/breathe/rain.svg"
                  alt="Rain Sounds"
                  width="20"
                  height="20"
                />
