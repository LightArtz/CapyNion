...
function Breathe() {
  ...
  return (
    <div className="flex min-h-screen font-hanken-grotesk" style={{ backgroundColor:'#A1DFF6' }}>
      <Sidebar />
      <div className="flex flex-col max-w-3xl mx-auto z-10 relative h-screen">
        <h1 className="mt-[45px] text-4xl font-bold mb-6" style={{ color: '#76B4CB' }}>Meditation Timer</h1>
        ...
        {selectedDuration !== null && (
          <div className="absolute inset-x-0 bottom-[3.3%] flex justify-center">
            ...
            <button
              ...
              style={{ transform: 'scale(0.51)', transformOrigin: 'center', marginLeft: '-12px' }}
            >
              <img 
