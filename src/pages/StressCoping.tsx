...
function StressCoping() {
  ...
  return (
    <div className="flex min-h-screen font-hanken-grotesk" style={{ background: 'linear-gradient(to bottom, #003281, #FFC24C)' }}>
      ...
      >
      <img
        className="h-[45%] absolute bottom-[13%] left-[44%] transform -translate-x-[28%]"
      ...
      />
        ...
        {clickedButton && (
          <button
            className="absolute bottom-[-40px] ml-[-100px] left-[53.8%] font-bold text-xl text-[#78C58D] bg-white hover:bg-[#e0e0e0] px-4 py-2 rounded-xl"
