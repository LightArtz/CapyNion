...
function FocusTimer() {
  ...
  return (
    <div className="flex w-screen min-h-screen font-hanken-grotesk" style={{ background: 'linear-gradient(to bottom, #073343, #1281A9)' }}>
      <Sidebar onNewChat={() => {}}/>
      <div className='flex flex-col items-center z-10 relative w-screen h-screen'>
        <div className="flex flex-col mx-auto z-10 relative h-screen">
      ...
      <img
        className="absolute bottom-[32%] left-[10%] w-[25%] z-[4] 
          2xl:bottom-[32%] 2xl:w-[25%]
          xl:bottom-[25%] xl:w-[400px]
          lg:bottom-[19%] lg:w-[400px]"
        src='../assets/focus/pine-trees.svg'
        alt="pine-trees"/>
      <img
        className="absolute bottom-[40%] right-0 w-[4%] z-[4]
          2xl:bottom-[40%] 2xl:w-[4%]
          xl:bottom-[35%] xl:w-[4%]
          lg:bottom-[30%] lg:w-[4%]"
